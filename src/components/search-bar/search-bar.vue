<script setup>
import { formateMonthDay } from "@/utils/formatDate";
...
const startDateStr = computed(() => formateMonthDay(startDate.value, "MM.DD"));
const endDateStr = computed(() => formateMonthDay(endDate.value, "MM.DD"));
</script>
